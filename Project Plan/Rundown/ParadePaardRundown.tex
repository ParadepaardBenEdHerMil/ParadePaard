...
The page has a conversation list and a selected thread. Each inbox row shows the employee name, email address, latest message preview, and an unread count when there are messages waiting for admin review. Opening a row shows the full conversation with that user.
