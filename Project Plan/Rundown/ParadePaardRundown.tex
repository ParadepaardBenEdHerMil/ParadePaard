...
The main management work pages now include an arrow-style Back to management control near the page title. This gives users a clear way to return from users, onboarding, planning, clients, travel claims, payslip review, all-payslips view, and management payslip details back to the Management Dashboard. Company settings also returns to Management when it is opened from the Management Dashboard.
